...
DTBS['ATK-RV1126-EVB'] = OrderedDict([('rv1126-alientek-1080p', '#_saradc_ch4=340'),
				('rv1126-alientek-800p', '#_saradc_ch4=680'),('rv1126-alientek', '#_saradc_ch4=0')])

DTBS['ATK-RV1126-EVB_720'] = OrderedDict([('rv1126-alientek', '#_saradc_ch4=0')])
DTBS['ATK-RV1126-EVB_800'] = OrderedDict([('rv1126-alientek-800p', '#_saradc_ch4=500')])
DTBS['ATK-RV1126-EVB_1080'] = OrderedDict([('rv1126-alientek-1080p', '#_saradc_ch4=340')])
...
#        print __doc__
    ...
    for dtb, value in TARGET_DTBS.items():
        if default_dtb:
            ori_file = 'arch/arm/boot/dts/' + dtb + '.dtb'
